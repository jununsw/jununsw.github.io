...
function principal_A() {
    ...
    $("#info-principal").html("Two arcs moving from point A to &sigma;<sub>1</sub> and &sigma;<sub>3</sub> are plotted<br/>2&theta; = " + Math.abs(prob.getTheta()).toFixed(2) + "&deg;, 180-2&theta; = " + (180 - 2*Math.abs(prob.getTheta())).toFixed(2) + "&deg;.");
...
function principal_B() {
    ...
    $("#info-principal").html("Two arcs moving from point B to &sigma;<sub>1</sub> and &sigma;<sub>3</sub> are plotted<br/>2&theta; = " + Math.abs(prob.getTheta()).toFixed(2) + "&deg;, 180-2&theta; = " + (180 - 2*Math.abs(prob.getTheta())).toFixed(2) + "&deg;.");
