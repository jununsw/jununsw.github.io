...
function GUI_log(e, t) {
    for (var a = 0; a < g_fnMessagesCallbackGUI.length; a++) g_fnMessagesCallbackGUI[a](e, t, arguments)
}
...
console.log("end of language.js"), console.log("end of css.js");
var g_fnMessagesCallbackGUI = [],
    g_printNoticeLikeFacebook = !1;
console.log("end of view.js");
var arrZooms_SI = [100, 200, 250, 500, 1e3],
    arrZooms2_SI = [.02, .025, .04, .05, .1, .2],
    defaultZoom_SI = .05,
    arrZooms_Imperial = [76.2, 152.4, 304.8],
    arrZooms = arrZooms_SI,
    arrZooms2 = arrZooms2_SI,
    defaultZoom = defaultZoom_SI,
    uniformZoom = .75,
    zNodeSize = nodeSize(),
    g_zoomSettingsLoads = new cViewSettings;
console.log("end of zoom.js");
var g_ch = String.fromCharCode(189);
console.log("end of grid.js");
var g_aToolBarIds = ["#tool_open", "#tool_save", "#tool_new", "#tool_zoom_out", "#tool_zoom_in", "#tool_select", "#tool_escape", "#tool_delete", "#tool_sections", "#tool_supports", "#tool_hinge", "#tool_load", "#tool_calc", "#tool_view", "#tool_settings", "#tool_tools"],
    ...
    g_timer_TBF_count = 6;
console.log("end of toolbar.js");
var touchscreenSnapDragged = null;
console.log("end of draw.js");
var g_TouchTimerDelay = 0;
canvas = null;
var g_mouseMoveLastTime = null,
    g_timerDragFinished = null,
    g_flagDraggingIsActive = !1,
    scrollOldX = -1,
    scrollOldY = -1,
    timeOutIdScrollFinished = null,
    g_touchMoveRestoreTimerId = null,
    gTimerTouchActive = null,
    gTimerIgnorePlaceLoad = {
        timer: null
    };
console.log("end of main.js");
var viewSettingsHinges = new cViewSettings;
console.log("end of hinge.js");
var flagBaseUnits = !1,
    userIdForm = new RegExp("^[^&^<^>^'^\"]+$");
console.log("end of sections.js");
var cursorOld = "default",
    viewSettingsSupports = new cViewSettings;
console.log("end of supports.js");
var viewSettingsLoads = new cViewSettings;
console.log("end of loads.js");
var gScrollBarWidth = null;
console.log("end of form.js"), console.log("end of new.js"), console.log("end of interface_structs.js");
...
console.log("end of output.js");
var g_fileName = "Saved project",
    g_fileName_bak = "Autosave";
console.log("end of import-export.js");
var g_interfNodes = [],
    g_interfBeams = [],
    g_interfLoads = [],
    g_modelMessages = new cMsgContainer;
solver_registerMessagesCallback(log_callback), GUI_registerMessagesCallback(log_callback), console.log("end of interface.js");
...
$(window).resize(function() {
    console.log("!win resize start"), canvas && (console.log("win resize start"), g_iPadChromeFixResolution && (window.innerWidth < $(window).width() || window.innerHeight < $(window).height()) ? (g_iPadChromeFixResolution = null, scrollOldX = -1, scrollOldY = -1, $(window).scrollTop(0), $(window).scrollLeft(0), $(window).resize()) : resizeScreen(canvas), console.log("win resize end"))
