...
<html lang="en">
    ...
    <body>
        <div style="max-width: 900px; border: 2px red solid; padding: 1em; margin: 2em auto;">
            ...
            <p>
                A timer will be set and shown in the upper right during the quiz. When the time is up, you cannot edit your answers further and need to submit.
            </p>
            <p>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#startbtn").click(function() {
                ...
                form.setAttribute("action", "main.php?v=" + ((new Date()).getTime()).toString());
