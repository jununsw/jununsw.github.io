...
var btn_info = {
    ...
    stress: "<p>centre: (&sigma;<sub>c</sub>, 0), &sigma;<sub>c</sub> = (&sigma;<sub>1</sub> + &sigma;<sub>3</sub>) / 2, and</p><p>Radius: R<sup>2</sup> = ((&sigma;<sub>1</sub> - &sigma;<sub>3</sub>) / 2)<sup>2</sup> + &tau;<sup>2</sup>, so</p><ul><li>&sigma;<sub>1</sub> = &sigma;<sub>c</sub> + R = <span id='info-s1'></span> kPa</li><li>&sigma;<sub>3</sub> = &sigma;<sub>c</sub> - R = <span id='info-s3'></span> kPa</li></ul><p>&sigma;<sub>1</sub> and &sigma;<sub>3</sub> are shown in the Mohr's Circle</p>",
...
function calculate_theta() {
    ...
    $("#theta-2").html((Math.abs(prob.getTheta() * 2)).toFixed(2));
    $("#theta-1").html((Math.abs(prob.getTheta() * 1)).toFixed(2));
}
...
function principal_A() {
    ...
    $("#info-principal").html("Two arcs moving from point A to &sigma;<sub>1</sub> and &sigma;<sub>3</sub> are plotted<br/>2&theta; = " + Math.abs(2 * prob.getTheta()).toFixed(2) + "&deg;, 180-2&theta; = " + (180 - 2*Math.abs(prob.getTheta())).toFixed(2) + "&deg;.");
...
function principal_B() {
    ...
    $("#info-principal").html("Two arcs moving from point B to &sigma;<sub>1</sub> and &sigma;<sub>3</sub> are plotted<br/>2&theta; = " + Math.abs(2 * prob.getTheta()).toFixed(2) + "&deg;, 180-2&theta; = " + (180 - 2*Math.abs(prob.getTheta())).toFixed(2) + "&deg;.");
...
function principal_Pole() {
    ...
    (function (){
        ...
        alpha1 = Math.abs(alpha1) % 90;
        alpha2 = Math.abs(alpha2) % 90;
        ...
        */
        var theta = Math.abs(prob.getTheta());
        var alpha1 = prob.beta + prob.getTheta();
        var alpha2 = ((90 - alpha1) <= 90) ? 90 - alpha1 : -alpha1 - 90;
        ...
        $("#info-principal").html("&theta; = " + theta.toFixed(2) +"&deg;, &alpha;<sub>1</sub> = " + alpha2.toFixed(2) + "&deg;, &alpha;<sub>2</sub> = " + alpha1.toFixed(2) + "&deg;.<br/>&sigma;<sub>1</sub> = " + prob.s1.toFixed(3) + " kPa, &sigma;<sub>3</sub> = " + prob.s2.toFixed(3) + " kPa.");
    })();
...
function principal_inlet1(additional) {
    ...
    if ($("#inlet1-principal").length == 0) {
        ...
        t1.append("text")
          ...
          .text("Green line for \u03c3" + (prob.a >= prob.b ? '1' : '3'));  // "Green line for \u03c33"
        ...
        t1.append("text")
          ...
          .attr("font-family", "serif")
          .style("font-size", "16px")
          .text("Purple line for \u03c3" + (prob.a >= prob.b ? '3' : '1'));
    ...
    if (additional == "pole") {
        if ($("#svg-inlet1-additional-pole").length == 0) {
            ...
            p1.append("text")
              ...
              .attr("font-family", "serif")
              .style("font-size", "16px")
              .text("Gold angle for \u03b1" + (prob.a >= prob.b ? '2' : '1'));  // .text("Gold angle for \u03b11");
            ...
            p1.append("text")
              ...
              .attr("font-family", "serif")
              .style("font-size", "16px")
              .text("Red angle for \u03b1" + (prob.a >= prob.b ? '1' : '2'));
        } else {
...
function principal_inlet2(additional) {
    ...
    if ($("#inlet2-principal").length == 0) {
        ...
        t2.append("text")
          ...
          .attr("font-family", "serif")
          .style("font-size", "16px")
          .text("Purple line for \u03c3" + (prob.a >= prob.b ? '3' : '1'));  // "Green line for \u03c33");
    ...
    if (additional == "pole") {
        if ($("#svg-inlet2-additional-pole").length == 0) {
            ...
            p2.append("text")
              ...
              .attr("font-family", "serif")
              .style("font-size", "16px")
              .text("Red angle for \u03b1" + (prob.a >= prob.b ? '1' : '2'));  // .text("Gold angle for \u03b11"););
        } else {
