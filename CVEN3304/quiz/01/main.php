...
if ((isset($_GET['v'])) && (abs($now - intval($_GET['v'])) <= 5)) {
    ...
    die("Access denied: not from Moodle!");
}

$id = isset($_POST["id"]) ? $_POST["id"] : "error";

if ($id == 'error') {
    die("Access denied: user not identified!");
} else {
                ...
                <div class="row after-hide">
                    <div class="col-xs-12" id="answers" style="border: none;">
                        <div id="main-body">
                            ...
                            <div id="p4">
                                <p>
                                    Given that the doubly reinforced section is in the uncracked and elastic region, find the neutral axis (d<sub>n</sub>) for the section shown in the figure. Positive moment is applied to all sections. Take E<sub>s</sub>/E<sub>c</sub> = 8 (5 Marks)
                                </p>
                                <div class="row" style="margin-top: 2px;">
                                    <div class="col-sm-4">
